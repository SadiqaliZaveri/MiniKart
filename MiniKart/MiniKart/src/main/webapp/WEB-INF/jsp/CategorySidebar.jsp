    ...
    <div class="panel panel-default">
      <div class="panel-heading">
        <h4 class="panel-title">
          <a data-toggle="collapse" href="#collapse${category.categoryId}"><c:out value="${category.categoryName}"/></a>
        </h4>
      </div>
      <div id="collapse${category.categoryId}" class="panel-collapse collapse">
        <ul class="list-group">
        <c:forEach var="sc" items="${category.subCategory}" >
          <li class="list-group-item"><c:out value="${sc.subCategoryName}"/><p></li>
        </c:forEach>         
        </ul>
      </div>
    </div>
