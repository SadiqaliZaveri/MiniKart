...
<div class="container pushfooter theme" style="max-width:500px;">
  <blockquote>
    <h4>Shipping Details | 2-4</h4>
  </blockquote>
  <form:form modelAttribute="supplier">
  <div class="form-group">
      <label for="CompanyName">Company Name:
	  </label>
      <form:input path="supplierName" cssClass="form-control" id="CompanyName" />
    </div>
    <div class="form-group">
      <label for="supplierDescription">Supplier Description:
	  </label>
      <form:input path="supplierDescription" cssClass="form-control" id="supplierDescription" />
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <form:input path="companyUrl" cssClass="form-control" id="URL" />
    </div>
    <div class="form-group">
